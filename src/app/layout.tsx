...
// Display face for headings. Its width axis lets headings run slightly
// expanded, echoing the wide letterforms of the SkyMind wordmark.
...
export default function RootLayout({
  ...
  return (
    // The font variables must live on <html>: Tailwind sets the base font-family
    // there, and on <body> they are undefined at that level, so every page fell
    // back to the visitor's system font.
    <html
      lang="en"
